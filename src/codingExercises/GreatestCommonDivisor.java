...
public class GreatestCommonDivisor {
    ...
    static int getGreatestCommonDivisor(int first, int second) {
        ...
        // loop through each divisor, compare if they are the same. keep - add to
        // return the last one.

        ArrayList<Integer> commonDivisors = new ArrayList<>();

        List<Integer> firstDivisors = getDivisors(first);
        List<Integer> secondDivisors = getDivisors(second);
